...
export default class EditTopic extends React.Component {
  ...
  handleSubmit(e) {
    ...
    $btn.button('loading');
    updateTopic(this.state._id, this.state.title, this.state.tags, this.state.content)
      .then(ret => {
        $btn.button('reset');
        ...
        <div className="panel-body">
          <form>
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="ipt-title" value={topic.title} onChange={this.handleChange.bind(this, 'title')} placeholder="" />
            </div>
            <div className="form-group">
